...
namespace NWH
{
    ...
    public abstract class Vehicle : MonoBehaviour
    {
        ...
        public MultiplayerInstanceType GetMultiplayerInstanceType => _multiplayerInstanceType;
        ...
        public virtual void Awake()
        {
            ...
            if(onSetMultiplayerInstanceType == null) onSetMultiplayerInstanceType = new UnityEvent();
            if(onSleep == null) onSleep = new UnityEvent();
            if(onWake == null) onWake = new UnityEvent();
        }
