...
namespace NWH.Common.SceneManagement
{
    public class VehicleChanger : MonoBehaviour
    {
        ...
        /// </summary>
        public bool deactivateAll = false;
        ...
        private void Start()
        {
            ...
            {
                Debug.LogError("CharacterBased is set to true but there is no CharacterVehicleChanger present in the scene.");
            }
