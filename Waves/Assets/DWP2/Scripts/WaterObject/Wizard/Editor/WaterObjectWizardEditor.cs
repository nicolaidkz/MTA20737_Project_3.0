...
namespace DWP2
{
    ...
    public class WaterObjectWizardEditor : DWP_NUIEditor
    {
        ...
        private bool _wizardFinished = false;
        ...
        public override bool OnInspectorNUI()
        {
            ...
            logoRect.height = 60f;
            drawer.DrawEditorTexture(logoRect, "Logos/WaterObjectWizardLogo");
            ...
            if (mf != null)
            {
                if (mf.sharedMesh != null)
                {
                    ...
                    {
                        drawer.Info("Large mesh detected. Expect WaterObjectWizard to take a few moments to setup this object.", MessageType.Info);
                    }
                }
            }
        ...
        private void RunWizard(WaterObjectWizard wow)
        {
            ...
            {
                GameObject waterParticleSystemPrefab = Resources.Load<GameObject>("DefaultWaterParticleSystem");
