...
namespace DWP2
{
	public static class MeshUtility
	{
		...
		public static void GenerateDummyMesh(ref Mesh originalMesh, ref Mesh dummyMesh,
			bool simplifyMesh = false, bool convexifyMesh = false, bool weldColocatedVertices = true, float simplificationRatio = 1f)
		{
			dummyMesh.vertices = originalMesh.vertices;
			dummyMesh.triangles = originalMesh.triangles;
